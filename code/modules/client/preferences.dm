...
/datum/preferences
	...
	var/hair_gradient = "000000"		//Hair gradient color
	...
	switch(current_tab)
		...
		if(2)
			...
			if(HAIR in pref_species.species_traits)
				...
				dat += "<b>Gradient</b><br>"
				dat += "<a href='?src=\ref[src];grad_color=1'>Change Color</a><span style='font-face: fixedsys; font-size: 14px; background-color: [hair_gradient]; color: [hair_gradient]'>___</span>"
				dat += " Style: <a href='?src=\ref[src];grad_style_left=[gradient_style]'><</a> <a href='?src=\ref[src];grad_style_right=[gradient_style]''>></a> <a href='?src=\ref[src];grad_style=1'>[gradient_style]</a><br>"
