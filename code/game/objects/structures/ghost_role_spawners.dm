...
/obj/effect/mob_spawn/human/ghostcafe/special(mob/living/carbon/human/new_spawn)
	if(new_spawn.client)
		...
		var/datum/mind/mind = new_spawn.mind
		if(mind)
			mind.AddElement(/datum/element/dusts_on_leaving_area,list(A.type,/area/hilbertshotel), TRUE) //it's (mostly) permanent (see dusts_on_leaving_area.dm)
